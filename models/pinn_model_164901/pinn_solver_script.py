...
class PINNSolver(nn.Module):
    ...
    def __init__(self, device, sigma_h, a, fr, ft, fd, layers=[3, 64, 64, 64, 1]):
        ...
        # Aggiungi layer di normalizzazione per migliorare la convergenza
...
class PINNTrainer:
    ...
    # Nota: il metodo adapt_weights è stato rimosso da qui perché è già definito nella classe PINNSolver
