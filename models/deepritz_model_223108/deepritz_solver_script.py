...
class DeepRitzTrainer:
    ...
    def train(self, epochs=10000, lr=1e-3, n_domain=8000, n_boundary=1600, n_initial=1600, T=35.0):
        """
        ...
        for epoch in range(epochs):
            # Genera nuovi dati ad ogni epoca per evitare problemi autograd
            ...
            # Loss totale con weights più bilanciati
            ...
            # Print progress più frequente per monitorare meglio
            if epoch % 250 == 0:
