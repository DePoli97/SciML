...
\subsubsection{Initial Model: $cnn_model_000001$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../models/cnn_model_000001/training_loss.png}
    \caption{Training loss for the initial CNN model ($cnn_model_000001$).}
    \label{fig:cnn_loss_1}
\end{figure}

\subsubsection{Advanced Model: $cnn_model_000002$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../models/cnn_model_000002/training_loss.png}
    \caption{Training and validation loss for the advanced ResUNet model ($cnn_model_000002$).}
    \label{fig:cnn_loss_2}
\end{figure}

\subsubsection{Further Experiments: $cnn_model_010647$ and $cnn_model_104653$}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{../models/cnn_model_010647/training_loss.png}
        \caption{Model $cnn_model_010647$}
        \label{fig:cnn_loss_3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{../models/cnn_model_104653/training_loss.png}
        \caption{Model $cnn_model_104653$}
...
\subsubsection{Model $deepritz_model_220842$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../models/deepritz_model_220842/training_loss.png}
    \caption{Training loss for the Deep Ritz model ($deepritz_model_220842$).}
...
\subsubsection{Model $pinn_model_113908$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../models/pinn_model_113908/training_loss.png}
    \caption{Training loss for the PINN model ($pinn_model_113908$).}
    \label{fig:pinn_loss}
\end{figure}